  ...
  return (
    <div className="min-h-screen bg-white pt-24">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-16">
        ...
        >
          <div className="absolute inset-0 bg-button opacity-80 rounded-2xl"></div>
          {/* Decorative S patterns */}
          <img src={s2Logo} alt="pattern" className="absolute -bottom-1 -left-0 w-60 h-auto opacity-85 pointer-events-none" />
          ...
          <div className="relative z-10">
            <p className="text-black text-sm font-semibold tracking-wider mb-2 inline-block bg-white bg-opacity-25 rounded px-6 py-1">Write to us</p>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-16 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">Contact us using the form or the details provided below.</p>
          ...
          <div className="bg-green-50 p-8 rounded-2xl">
            <div className="relative mb-8">
              ...
              <div className="absolute top-0 right-0 w-32 h-32 pointer-events-none">
                <div
                  className="absolute top-0 left-0 w-full h-full bg-button"
                  style={{
                    maskImage: `url(${sLogo})`,
                    maskSize: 'contain',
                ...
                ></div>
                <div
                  className="absolute top-2 left-2 w-full h-full bg-button"
                  style={{
                    maskImage: `url(${sLogo})`,
                    maskSize: 'contain',
                    maskRepeat: 'no-repeat',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">+1 (098) 946-8777</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">+234 818 902 9874</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">info@seamtrack.net</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">sales@seamtrack.net</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">tech@seamtrack.net</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">www.seamtrack.net</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-green-200">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">11 Tunde Fataye Street, Lekki Phase 1 Lagos, Nigeria</p>
                </div>
              </div>
            </div>
          </div>
